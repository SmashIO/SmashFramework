...
package io.smash.debug
{
    ...
    public class Console extends Sprite implements ILogAppender, ITicked, ISEManager
    {
        ...
        public function initialize():void
        {
            ...
            _currentGroup = Smash._rootGroup;
        ...
        public function onTick():void
        {
            ...
            var endLine:int = 0;
            if (bottomLineIndex == int.MAX_VALUE)
                startLine = SmashUtil.clamp(logCache.length - lineHeight, 0, int.MAX_VALUE);
            else
                startLine = SmashUtil.clamp(bottomLineIndex - lineHeight, 0, int.MAX_VALUE);
            
            endLine = SmashUtil.clamp(startLine + lineHeight, 0, logCache.length - 1);
